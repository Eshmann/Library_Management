...
namespace WindowsFormsApp1
{
    public partial class issue_books : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                books_qty = Convert.ToInt32(dr2["avaliable_qty"].ToString());
            }
            ...
            if (books_qty > 0)
            {
               SqlCommand cmd = con.CreateCommand();
               cmd.CommandType = CommandType.Text;
               cmd.CommandText = "insert into issue_books values('"+ txt_enrollment.Text +"','"+ txt_studentname.Text +"','"+ txt_studentdept.Text +"','"+ txt_stuxdentsem.Text +"','"+ txt_studentcontact.Text +"','"+ txt_studentemail.Text +"','"+ txt_booksname.Text +"','"+ dateTimePicker1.Value.ToShortTimeString() +"','')";
               cmd.ExecuteNonQuery();

               SqlCommand cmd1 = con.CreateCommand();
               cmd1.CommandType = CommandType.Text;
               cmd1.CommandText = "update books_info set avaliable_qty=avaliable_qty-1 where books_name='"+ txt_booksname.Text +"'";
            ...
            {
                MessageBox.Show("books not avaliable");
            }
        }
    }
}
