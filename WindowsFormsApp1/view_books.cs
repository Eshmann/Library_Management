    ...
    public partial class view_books : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                foreach(DataRow dr in dt.Rows)
                {
                    ...
                    authorname.Text = dr["books_author"].ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update books_info set books_name='"+ booksname.Text +"',books_author='"+ authorname.Text +"',books_publication_name='"+ publicationname.Text +"',books_purchase_date='"+ dateTimePicker1.Value +"',books_price="+ booksprice.Text +",books_quantity='"+ booksqty.Text +"' where id="+i+"";
                cmd.ExecuteNonQuery();
                con.Close();
                disp_books();
